...
![](/assets/image/lambda.png)

> 람다 아키텍처에 대한 솔루션 매핑 사례

![](/assets/image/lambda_solution_mapping.png)

## Monitoring Architecture(Reference)

<img src="/assets/image/architecture.png" width="850" height="300">
...
![](/assets/image/column_family.png)
...
<img src="/assets/image/hbase_architecture.jpg" width="700" height="400">
...
![](/assets/image/hbase_meta1.png)

* 클라이언트는 주키퍼의 META 테이블을 서비스하는 리전 서버의 호스트 정보를 읽어온다.

![](/assets/image/hbase_meta.png)
...
![](/assets/image/hbase_region_components.png)
...
![](/assets/image/storm_architecture.png)
...
![](/assets/image/storm_components.png)
...
![](/assets/image/kafka_concept.png)
